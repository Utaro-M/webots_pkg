...
class detect_state(smach.State):
    def __init__(self, func):
        smach.State.__init__(self, outcomes=['swim_forward', 'turn_left', 'turn_right',# 'turn_left_with_move_forward', 'turn_right_with_move_forward',
                                             'finish', 'other_state'],
        ...
        with sm_sub0:
            smach.StateMachine.add('detect_state', detect_state(lib.detect_trash),
                                   transitions={'swim_forward':'swim_forward_state',
                                                'turn_left'   :'turn_left_state',
                                                'turn_right'  :'turn_right_state',
                                                # 'turn_left_with_move_forward'   :'turn_left_with_move_forward_state',
                                                # 'turn_right_with_move_forward'  :'turn_right_with_move_forward_state',
                                                'other_state' :'other_state',
                                                'finish'      :'finish'} )
            ...
            smach.StateMachine.add('turn_right_state', turn_right_state(lib.turn_right),
                                   transitions={'to_next':'detect_state'})
            # smach.StateMachine.add('turn_left_with_move_forward_state', turn_left_with_move_forward_state(lib.turn_left,lib.swim_forward),
            #                        transitions={'to_next':'detect_state'})
            # smach.StateMachine.add('turn_right_with_move_forward_state', turn_right_with_move_forward_state(lib.turn_right,lib.swim_forward),
            #                        transitions={'to_next':'detect_state'})
